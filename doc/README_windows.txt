...
Intro
-----
LoMoCoin is a free open source project derived from Bitcoin, with
...
Setup
-----
After completing windows setup then run lomocoin-qt.
Alternatively you can run windows command line (cmd) in lomocoin program dir.
  cd daemon
  lomocoind
You would need to create a configuration file lomocoin.conf in the default
wallet directory. Grant access to lomocoind/lomocoin-qt in anti-virus and firewall
...
lomocoind backupwallet <destination_backup_file>
Then shutdown lomocoind by
lomocoind stop
...
See the documentation/wiki at github:
  http://github.com/lomocoin/lomocoin
