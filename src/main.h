...
//static const int COINBASE_MATURITY_PPC = 5;
...
static const uint256 hashGenesisBlockOfficial("0x000000e4aa6377830771e4d5ff8a52bd90468e28d47e2be403d0fbd81aff8b40");
static const uint256 hashGenesisBlockTestNet("0x0000195bf673100447e3e8a557f9089fec55156522ea7589c7653f4a3d112c69");
...
public:
    ...
    */
    ...
    bool CheckInputs(CTxDB& txdb);
    bool AcceptToMemoryPool(CTxDB& txdb, bool fCheckInputs=true, bool* pfMissingInputs=NULL);
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // lomocoin: get transaction coin age
...
public:
    ...
    // lomocoin: block signature - signed by coin base txout[0]'s owner
    ...
    // lomocoin: two types of block: proof-of-work or proof-of-stake
    ...
    // lomocoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // lomocoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // lomocoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // lomocoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // lomocoin: block index flags
    enum  
    {
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("04defa7de47a86c38c3358e5151d4bb82bb9c1dbcf5a60d4c501d7cb40d3974900f0c42f9ce9f4fbd66965665d0d4c9f107e1908a73c188b71ddbdb1c041e7263c")))
