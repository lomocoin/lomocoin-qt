...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        capsLabel->setStyleSheet(QLatin1String("#capsLabel {\n"
"	font: bold;\n"
"}"));
    ...
    {
        AskPassphraseDialog->setWindowTitle(QApplication::translate("AskPassphraseDialog", "Dialog", Q_NULLPTR));
        ...
        capsLabel->setText(QApplication::translate("AskPassphraseDialog", "TextLabel", Q_NULLPTR));
    } // retranslateUi
